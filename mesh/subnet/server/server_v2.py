...
from mesh.dht.validation import HypertensorPredicateValidator
...
from mesh.subnet.server.inference_protocol_v3 import InferenceProtocol
...
print("PUBLIC_INITIAL_PEERS", PUBLIC_INITIAL_PEERS)
class ServerV2:
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.dht = DHT(
            ...
            # record_validators=[consensus_predicate],
            **kwargs,
        )
        ...
        self.inference_protocol = InferenceProtocol(
            dht=self.dht,
            model_name=self.converted_model_name_or_path,
            start=True
        )
...
#         # bootstrap = hivemind.PeerID.from_base58("QmNV5G3hq2UmAck2htEgsqrmPFBff5goFZAdmKDcZLBZLX")
#         # if self.dht.peer_id.__eq__(bootstrap):
#         #     model = InferenceModel(self.converted_model_name_or_path)
#         #     async_model = AsyncInferenceServerV5(model)
...
#         #     record_validator=record_validator,
#         #     hypertensor=MockHypertensor(),
#         #     model_name_or_path=self.converted_model_name_or_path
#         # )
...
#             return
#         print("_ping_next_servers module_infos", module_infos)
#         # middle_servers = {peer_id for info in module_infos[:-1] for peer_id in module_infos}
#         # middle_servers = {peer_id for peer_id in module_infos}
#         # middle_servers = {info.peer_id for info in module_infos[:-1]}
#         middle_servers = {info.peer_id for info in module_infos}
#         print("_ping_next_servers middle_servers", middle_servers)
#         pinged_servers = set(sample_up_to(middle_servers, self.max_pinged))
#         print("_ping_next_servers pinged_servers", pinged_servers)
#         print("_ping_next_servers pinged_servers", list(pinged_servers))
#         # discord self
...
#         # pinged_servers |= set(sample_up_to(module_infos[-1].server, self.max_pinged))
