...
# pytest tests/test_consensus_v5.py -rP

class DummyInferenceProtocol:
    async def rpc_inference_stream(self, tensor):
        return tensor * 2  # fake inference

# pytest tests/test_consensus_v5.py::test_consensus -rP
# pytest tests/test_consensus_v5.py::test_consensus --log-cli-level=DEBUG
...
# pytest tests/test_consensus_v5.py::test_consensus_with_key_validator -rP
# pytest tests/test_consensus_v5.py::test_consensus_with_key_validator --log-cli-level=DEBUG
